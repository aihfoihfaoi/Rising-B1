...
import me.Axolotelgamer30.Rising.alt.AltLoginThread;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(5, 10, 5, 100, 20, I18n.format("Random Offline", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.fontRendererObj, I18n.format(this.mc.session.getUsername(), new Object[0]), 115, 13, -7829368);
