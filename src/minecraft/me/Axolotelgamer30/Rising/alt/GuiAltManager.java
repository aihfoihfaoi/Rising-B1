...
public class GuiAltManager extends GuiScreen {
	...
	public void actionPerformed(GuiButton button) throws IOException {
		...
		case 2: {
			...
			AltManager altManager = Rising.instance.altManager;
		...
		case 3: {
			...
			// this.mc.displayGuiScreen(new AccountLogin());
			break;
		}
		case 4: {
			this.mc.displayGuiScreen(new GuiMSAltLogin());
		...
		case 9: {
			this.loginThread = new AltLoginThread("Rising_" + generateRandomString(), "");
			this.loginThread.start();
			break;
		}
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		GL11.glEnable(3089);
		int y2 = 38;
		AltManager altManager2 = Rising.instance.altManager;
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(4, width / 2 - 50, height - 48, 100, 20, "MS Login"));
		...
		this.buttonList.add(new GuiButton(9, width - 260, 0, 100, 20, "Random Offline"));
		this.login.enabled = false;
		this.remove.enabled = false;
		this.rename.enabled = false;
	}
